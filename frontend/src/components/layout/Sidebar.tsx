...
const SidebarContent: React.FC<SidebarContentProps> = ({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-white">
      ...
      {/* ========================================================
         SIDEBAR FOOTER (Blended to match Footer component)
      ======================================================== */}
      <div className="shrink-0 border-t border-slate-200 bg-slate-900 px-6 py-4 text-xs text-slate-400">
        <p className="font-medium text-slate-200">MCCTEST Portal</p>
  ...
  return (
    <>
      ...
      >
        ...
        ====================================================== */}
        <div className="flex h-16 shrink-0 items-center justify-between border-b border-slate-200 px-5 bg-white">
